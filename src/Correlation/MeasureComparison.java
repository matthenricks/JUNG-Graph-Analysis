...
public class MeasureComparison {
	...
	static Comparator<Entry<String, Double>> entrySort = new Comparator<Entry<String,Double>>() {
		@Override
	...
	public static List<CSV_Builder> correlationCompare(
		...
		ArrayList<CSV_Builder> csvs = new ArrayList<CSV_Builder>(6);
		// First, slice the sample up
		double[] sampleSlices = {0.05, 0.1, 0.2, 0.3, 0.4, 1.0};
		for (double sliceSize : sampleSlices) {
